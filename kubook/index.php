...
if(!isset($_SESSION['user_id']) || !isset($_SESSION['user_name'])) {
            ...
            <section class="sidebar">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="./index.php"><i class="fa fa-circle-o"></i>Search Book</a></li>
    ...
    foreach ($results as $result){
        ...
        <tr>
            ...
            <td><?
                if($result['status'] == 0){
                    ?>
                    <button type="button" onclick="do_rental(<?=$result['id']?>)" class="btn btn-block btn-success">Rental</button>
                    <?
                }else{
                    ?>
                    <button type="button" class="btn btn-block btn-danger">On Rental</button>
                    <?
                }
                ?>
            </td>
    ...
    <script>
        function do_rental(id){
            $.get(
                "action_rental.php",
                {user_id: <?=$_SESSION['user_pk']?> ,book_id : id},
                function(data) {
                    alert(data);
                    location.reload();
                }
