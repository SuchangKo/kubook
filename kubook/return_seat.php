...
if(!isset($_SESSION['user_id']) || !isset($_SESSION['user_name'])) {
            ...
            <section class="sidebar">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active"><a href="./return_seat.php"><i class="fa fa-circle-o"></i>Return Seat</a></li>
                        </ul>
                    </li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="./manage_book.php"><i class="fa fa-circle-o"></i>Manage Book</a></li>
                        </ul>
                    </li>
                    <? } ?>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Rental History</h3>
    ...
    $check_query="SELECT *, (SELECT seat_number FROM seat s WHERE s.id=history.seat_id) seat_number, (SELECT status FROM seat s WHERE s.id=history.seat_id) status FROM rental_seat_history history WHERE history.user_id = ".$_SESSION['user_pk']." order by id desc";
    ...
    foreach ($results as $result){
        ...
        <tr>
            ...
            <td><?=$result['rental_start']?></td>
            <td><?=$result['rental_finish']?></td>
            <td><?
                if($result['status'] == 1){
                    ?>
                    <button type="button" class="btn btn-block btn-info">Returned</button>
                    <?
                }else{
                    ?>
                    <button type="button" onclick="do_return(<?=$result['id']?>,<?=$result['seat_number']?>)" class="btn btn-block btn-danger">Do Return</button>
                    <?
                }
                ?>
            </td>
    ...
    <script>
        function do_return(id,seat_number){
            $.get(
                "action_return_seat.php",
                {return_id : id,seat_number:seat_number},
                function(data) {
                    alert(data);
                    location.reload();
                }
