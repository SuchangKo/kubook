...
if(!isset($_SESSION['user_id']) || !isset($_SESSION['user_name'])) {
            ...
            <section class="sidebar">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active" ><a href="./return_book.php"><i class="fa fa-circle-o"></i>Return Book</a></li>
    ...
    $check_query="SELECT *, (SELECT title FROM book b WHERE b.id=history.book_id) title FROM rental_book_history history WHERE history.user_id = ".$_SESSION['user_pk'];
        ...
        <tr>
            ...
            <td><?
                if($result['return_status'] == 1){
                    ...
                    ?>
                    <button type="button" onclick="do_return(<?=$result['id']?>)" class="btn btn-block btn-danger">Do Return</button>
                    <?
                }
                ?>
            </td>
