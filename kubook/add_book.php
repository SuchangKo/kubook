        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li  class="active"><a href="./add_book.php"><i class="fa fa-circle-o"></i>Add Book</a></li>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box box-primary">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form role="form" action="action_add_book.php" method="post">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="publisher" name="publisher">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">publish_year</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="publish_year (ex, 2018)" name="publish_year">
                                    </div>
                                    <div class="form-group">
